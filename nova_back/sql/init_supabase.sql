...
CREATE TABLE IF NOT EXISTS utilisateurs (
  ...
  role               TEXT NOT NULL DEFAULT 'technicien'
                       CHECK (role IN ('admin','technicien','data','entreprise')),
...
CREATE TABLE IF NOT EXISTS alertes (
  id               SERIAL PRIMARY KEY,
  source_type      TEXT NOT NULL DEFAULT 'citoyen'
...
CREATE OR REPLACE TRIGGER alertes_ts
...
CREATE OR REPLACE TRIGGER interventions_ts
...
CREATE TABLE IF NOT EXISTS alertes_internes (
  ...
  priorite         TEXT NOT NULL DEFAULT 'basse'
                     CHECK (priorite IN ('basse','moyenne','haute')),
  description      TEXT,
...
CREATE OR REPLACE TRIGGER alertes_internes_ts
...
CREATE TABLE IF NOT EXISTS diagnostics (
  ...
  esp_wifi_active BOOLEAN      DEFAULT NULL,
  esp_now_tx_ok   BOOLEAN      DEFAULT NULL,
